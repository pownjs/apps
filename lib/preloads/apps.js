...
const bootAPI = () => {
    ...
    window.addEventListener('DOMContentLoaded', async() => {
        ...
        const genericChannel = new GenericChannel(window)

        genericChannel.listen('makeRequest(f7f34d94-67be-4dad-b297-9fd890dd25ba)', MakeRequestHandler)
        genericChannel.listen('observeTransactions(a34a46f4-fd1d-4f8e-94fc-69ed030a6fe3)', ObserveTransactionsHandler)
    })
}
