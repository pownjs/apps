...
},{"./legacy":2,"babel-runtime/helpers/classCallCheck":15}],2:[function(require,module,exports){
...
},{"../handlers":3,"../lib/runtime":5,"babel-runtime/core-js/object/entries":11,"babel-runtime/helpers/classCallCheck":15,"babel-runtime/helpers/createClass":16,"babel-runtime/helpers/extends":17,"babel-runtime/helpers/objectWithoutProperties":18,"babel-runtime/helpers/slicedToArray":19}],3:[function(require,module,exports){
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}var _class,_temp,_stringify=require("babel-runtime/core-js/json/stringify"),_stringify2=_interopRequireDefault(_stringify),_classCallCheck2=require("babel-runtime/helpers/classCallCheck"),_classCallCheck3=_interopRequireDefault(_classCallCheck2),_createClass2=require("babel-runtime/helpers/createClass"),_createClass3=_interopRequireDefault(_createClass2),_api=require("./api"),_runtime=require("./lib/runtime"),_handlers=require("./handlers");window.websecurify=new _api.LegacyAPI(new _runtime.GenericRuntime(window)),window.secappsExtensionAPI=new _api.SecappsExtensionAPI(new _runtime.GenericRuntime(window));var secappsExtensionWorkerUri=window.secappsExtensionWorkerUri;delete window.window.secappsExtensionWorkerUri,window.Worker=(_temp=_class=function(){function e(r){(0,_classCallCheck3.default)(this,e),r=new URL(r,window.location.href).href;var n=this.constructor.Worker,t=new Blob(["importScripts("+(0,_stringify2.default)([secappsExtensionWorkerUri,r]).slice(1,-1)+")"],{type:"text/javascript"}),i=new n(URL.createObjectURL(t)),s=new _runtime.RuntimeProxy(new _runtime.GenericRuntime(i),new _runtime.GenericRuntime(window));s.listen(_handlers.pingType),s.listen(_handlers.makeRequestType),s.listen(_handlers.observeTransactionsType),this.worker=i,this.workerProxy=s}return(0,_createClass3.default)(e,[{key:"addEventListener",value:function(){var e;(e=this.worker).addEventListener.apply(e,arguments)}},{key:"removeEventListener",value:function(){var e;(e=this.worker).removeEventListener.apply(e,arguments)}},{key:"dispatchEvent",value:function(){var e;(e=this.worker).dispatchEvent.apply(e,arguments)}},{key:"postMessage",value:function(){var e;(e=this.worker).postMessage.apply(e,arguments)}},{key:"terminate",value:function(){tihs.workerProxy.disconnect(),this.worker.terminate()}},{key:"onerror",get:function(){throw new Error("not implemented")},set:function(e){throw new Error("not implemented")}},{key:"onmessage",get:function(){throw new Error("not implemented")},set:function(e){throw new Error("not implemented")}},{key:"onmessageerror",get:function(){throw new Error("not implemented")},set:function(e){throw new Error("not implemented")}}]),e}(),_class.Worker=Worker,_temp);


},{"./api":1,"./handlers":3,"./lib/runtime":5,"babel-runtime/core-js/json/stringify":8,"babel-runtime/helpers/classCallCheck":15,"babel-runtime/helpers/createClass":16}],5:[function(require,module,exports){
...
},{"babel-runtime/core-js/object/get-own-property-descriptor":12,"babel-runtime/helpers/classCallCheck":15,"babel-runtime/helpers/createClass":16,"react-suite-decorators/lib/auto-bind":105,"react-suite-decorators/lib/one-time":106}],6:[function(require,module,exports){
module.exports={default:require("core-js/library/fn/get-iterator"),__esModule:!0};


},{"core-js/library/fn/get-iterator":21}],7:[function(require,module,exports){
module.exports={default:require("core-js/library/fn/is-iterable"),__esModule:!0};


},{"core-js/library/fn/is-iterable":22}],8:[function(require,module,exports){
module.exports={default:require("core-js/library/fn/json/stringify"),__esModule:!0};


},{"core-js/library/fn/json/stringify":23}],9:[function(require,module,exports){
...
},{"core-js/library/fn/object/entries":26}],12:[function(require,module,exports){
...
},{"../core-js/get-iterator":6,"../core-js/is-iterable":7}],20:[function(require,module,exports){
...
},{"../modules/core.get-iterator":90,"../modules/es6.string.iterator":97,"../modules/web.dom.iterable":102}],22:[function(require,module,exports){
require("../modules/web.dom.iterable"),require("../modules/es6.string.iterator"),module.exports=require("../modules/core.is-iterable");


},{"../modules/core.is-iterable":91,"../modules/es6.string.iterator":97,"../modules/web.dom.iterable":102}],23:[function(require,module,exports){
...
},{"../../modules/_core":36}],24:[function(require,module,exports){
require("../../modules/es6.object.assign"),module.exports=require("../../modules/_core").Object.assign;


},{"../../modules/_core":36,"../../modules/es6.object.assign":93}],25:[function(require,module,exports){
...
},{"../../modules/_core":36,"../../modules/es6.object.to-string":96,"../../modules/es6.symbol":98,"../../modules/es7.symbol.async-iterator":100,"../../modules/es7.symbol.observable":101}],29:[function(require,module,exports){
require("../../modules/es6.string.iterator"),require("../../modules/web.dom.iterable"),module.exports=require("../../modules/_wks-ext").f("iterator");


},{"../../modules/_wks-ext":87,"../../modules/es6.string.iterator":97,"../../modules/web.dom.iterable":102}],30:[function(require,module,exports){
...
},{"./_descriptors":39,"./_object-dp":61,"./_property-desc":73}],48:[function(require,module,exports){
...
},{"./_hide":47,"./_object-create":60,"./_property-desc":73,"./_set-to-string-tag":75,"./_wks":88}],54:[function(require,module,exports){
...
},{"./_export":43,"./_has":46,"./_hide":47,"./_iter-create":53,"./_iterators":56,"./_library":57,"./_object-gpo":67,"./_redefine":74,"./_set-to-string-tag":75,"./_wks":88}],55:[function(require,module,exports){
...
},{"./_descriptors":39,"./_has":46,"./_ie8-dom-define":49,"./_object-pie":70,"./_property-desc":73,"./_to-iobject":81,"./_to-primitive":84}],64:[function(require,module,exports){
...
},{"./_object-keys":69,"./_object-pie":70,"./_to-iobject":81}],73:[function(require,module,exports){
...
},{"./_classof":34,"./_core":36,"./_iterators":56,"./_wks":88}],92:[function(require,module,exports){
...
},{"./_add-to-unscopables":31,"./_iter-define":54,"./_iter-step":55,"./_iterators":56,"./_to-iobject":81}],93:[function(require,module,exports){
var $export=require("./_export");$export($export.S+$export.F,"Object",{assign:require("./_object-assign")});


},{"./_export":43,"./_object-assign":59}],94:[function(require,module,exports){
...
},{"./_iter-define":54,"./_string-at":78}],98:[function(require,module,exports){
...
},{"./_an-object":32,"./_descriptors":39,"./_enum-keys":42,"./_export":43,"./_fails":44,"./_global":45,"./_has":46,"./_hide":47,"./_is-array":51,"./_library":57,"./_meta":58,"./_object-create":60,"./_object-dp":61,"./_object-gopd":63,"./_object-gopn":65,"./_object-gopn-ext":64,"./_object-gops":66,"./_object-keys":69,"./_object-pie":70,"./_property-desc":73,"./_redefine":74,"./_set-to-string-tag":75,"./_shared":77,"./_to-iobject":81,"./_to-primitive":84,"./_uid":85,"./_wks":88,"./_wks-define":86,"./_wks-ext":87}],99:[function(require,module,exports){
var $export=require("./_export"),$entries=require("./_object-to-array")(!0);$export($export.S,"Object",{entries:function(e){return $entries(e)}});


},{"./_export":43,"./_object-to-array":72}],100:[function(require,module,exports){
...
},{"./_global":45,"./_hide":47,"./_iterators":56,"./_wks":88,"./es6.array.iterator":92}],103:[function(require,module,exports){
...
},{"mimic-fn":103}],105:[function(require,module,exports){
...
},{"babel-runtime/core-js/object/define-property":10,"babel-runtime/helpers/typeof":20}],106:[function(require,module,exports){
